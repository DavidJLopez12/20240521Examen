...
public class SuperControladorJPA {
	...
	protected EntityManager getEntityManager () {
		if (em == null) {
			em = Persistence.createEntityManagerFactory("20240521Examen")
				.createEntityManager();
		}
		return em;
	}
	...
	public List<? extends Entidad> findbyNombre () {
		return (List<Entidad>) 
		getEntityManager()
		.createNativeQuery("SELECT * FROM " + this.nombreTabla, this.tipoEntidad + " order by nombre")
		.getResultList();
	}
	...
	public List<? extends Entidad> findByEquipo (String tableColumn, String likeText) {
		return findByLikeOperator(tableColumn, likeText, true);
	}
